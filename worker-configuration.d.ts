/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4b895b34fb8e3c81b48b09d8954da60d)
// Runtime types generated with workerd@1.20250823.0 2025-08-15 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		SITE_ANALYSIS_CACHE: KVNamespace;
		NODE_ENV: "development";
		OPENAI_API_KEY: string;
		EXTERNAL_FETCHER: string;
		...
		SITE_ANALYSIS_DO: DurableObjectNamespace<import("./src/worker").SiteAnalysisDO>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "OPENAI_API_KEY" | "EXTERNAL_FETCHER" | "EXTERNAL_FETCHER_API_KEY">> {}
}
